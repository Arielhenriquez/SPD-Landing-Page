    ...
    class CDN_Clear_Cache_Api {
        ...
        public static function cache_api_call($files, $action = 'purge') {
            ...
            if ($action) {
                ...
                // purge additional domains as well as maindomains if configured to do so
                $include_additional_domains = false;
                if (defined('CDN_PURGE_ALL_DOMAINS') &&  CDN_PURGE_ALL_DOMAINS) {
                    $include_additional_domains = true;
                }

                if($include_additional_domains) {
                    $curl_url = add_query_arg('include_additional_domains', 'true', $curl_url);
                }
