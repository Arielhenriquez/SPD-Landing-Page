...
class RepeaterField extends BaseFieldManager
{
    ...
    protected function getResponseHtml($response, $fields, $columns)
    {
        ob_start();
        ?>
        <div class="ff_entry_table_wrapper" style="display: block; overflow-x: auto; width: 100%; max-width: 100%; -webkit-overflow-scrolling: touch;">
            <table class="ff_entry_table_field ff-table" style="display: table; width: max-content; min-width: 100%; table-layout: auto;">
                <thead>
                <tr>
