...
if ( ! class_exists( 'SP_WPCP_Framework_Field_gallery' ) ) {
	...
	class SP_WPCP_Framework_Field_gallery extends SP_WPCP_Framework_Fields {
		 ...
		 *
		 * @param  mixed $value sanitize values.
		 * @return statement
		 */
		...
		public function render() {
			...
			echo '<a href="#" class="button button-primary sp_wpcp-button"><img src="' . esc_url( WPCAROUSEL_URL ) . 'Admin/img/add-image.svg" alt="">' . esc_html( $args['add_title'] ) . '</a>';
