	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'title_help' =>
					'<div class="sp_wpcp-info-label">' . __( 'Carousel Orientation', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Choose the carousel slide movement:', 'wp-carousel-pro' ) . '<br>
						<strong style="font-weight: 700;">' . __( 'Horizontal', 'wp-carousel-pro' ) . '</strong>: ' . __( 'If you want the slides to transition horizontally, select', 'wp-carousel-pro' ) . ' <b>' . __( 'Horizontal', 'wp-carousel-pro' ) . '</b>.<br>
						<strong style="font-weight: 700;">' . __( 'Vertical', 'wp-carousel-pro' ) . '</strong>:  ' . __( 'If you want the slides to transition vertically, select', 'wp-carousel-pro' ) . ' <b>' . __( 'Vertical', 'wp-carousel-pro' ) . '</b></div><a class="sp_wpcp-open-docs" href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/configurations/how-to-configure-the-carousel-orientation/" target="_blank">' . __( 'Open Docs', 'wp-carousel-pro' ) . '</a><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/carousel-orientations/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
				'options'    => array(
			...
			array(
				...
				'title_help' =>
					'<div class="sp_wpcp-info-label">' . __( 'Slide Effect', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Enhance your slide transition with charming Slide Effects to add elegance and dynamic motion to your slides.', 'wp-carousel-pro' ) . '</div>',
				'options'    => array(
			...
			array(
				...
				'title_help' =>
					'<div class="sp_wpcp-info-label">' . __( 'Slider Orientation', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">
					<strong style="font-weight: 700;">' . __( 'Horizontal', 'wp-carousel-pro' ) . '</strong>: ' . __( 'If you want the slides to transition horizontally, select', 'wp-carousel-pro' ) . ' <b>' . __( 'Horizontal', 'wp-carousel-pro' ) . '</b>.<br>
					<strong style="font-weight: 700;">' . __( 'Vertical', 'wp-carousel-pro' ) . '</strong>:  ' . __( 'If you want the slides to transition vertically, select', 'wp-carousel-pro' ) . ' <b>' . __( 'Vertical', 'wp-carousel-pro' ) . '</b></div><a class="sp_wpcp-open-docs" href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/configurations/how-to-configure-the-carousel-orientation/" target="_blank">' . __( 'Open Docs', 'wp-carousel-pro' ) . '</a><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/carousel-orientations/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
				'options'    => array(
					'horizontal' => __( 'Horizontal', 'wp-carousel-pro' ),
			...
			array(
				...
				'title_help' => '<div class="sp_wpcp-info-label">' . __( 'Scheduling', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Enable the scheduling feature to set the specific date and time for your carousel sliders or galleries to be displayed (perfect for highlighting time-sensitive content).', 'wp-carousel-pro' ) . '</div><a class="sp_wpcp-open-docs" href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/configurations/how-to-configure-the-scheduling-feature/" target="_blank">' . __( 'Open Docs', 'wp-carousel-pro' ) . '</a><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/scheduled-carousel/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
				'default'    => false,
