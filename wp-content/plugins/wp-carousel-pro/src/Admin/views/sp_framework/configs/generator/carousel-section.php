					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_help' =>
									'<div class="sp_wpcp-info-label">' . __( 'AutoPlay Delay Time', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Set autoplay delay or interval time. The amount of time to delay between automatically cycling a item. e.g. 1000 milliseconds(ms) = 1 second.', 'wp-carousel-pro' ) . '</div>',
							...
							array(
								...
								'title_help' => '<div class="sp_wpcp-info-label">' . __( 'Carousel Speed', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Set carousel scrolling speed. e.g. 1000 milliseconds(ms) = 1 second.', 'wp-carousel-pro' ) . '</div>',
								'unit'       => __( 'ms', 'wp-carousel-pro' ),
								'step'       => 50,
								'min'        => 100,
								'max'        => 20000,
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_help' => '<div class="sp_wpcp-info-label">' . __( 'Free Mode', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Enable this feature to allow users to freely scroll and position the slides at anywhere instead of specific positions.', 'wp-carousel-pro' ) . '</div><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/free-mode-carousel/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
								'default'    => false,
								'text_on'    => __( 'Enabled', 'wp-carousel-pro' ),
								'text_off'   => __( 'Disabled', 'wp-carousel-pro' ),
								'text_width' => 95,
							...
							array(
								...
								'type'       => 'switcher',
								'title'      => __( 'Mousewheel Scroll', 'wp-carousel-pro' ),
