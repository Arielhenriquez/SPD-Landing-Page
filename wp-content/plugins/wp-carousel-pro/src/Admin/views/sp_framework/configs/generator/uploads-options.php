	...
	array(
		'fields' => array(
			...
			array(
				...
				'button_title'           => '<i class="fa fa-plus-circle"></i> ' . __( 'Add Audio', 'wp-carousel-pro' ),
				...
				'fields'                 => array(
					array(
						...
						'title'   => __( 'Source', 'wp-carousel-pro' ),
						'options' => array(
							'embed'       => array(
			...
			array(
				'id'         => 'wpcp_external_source_type',
				'type'       => 'button_set',
				'title'      => __( 'Source Type', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Select external source type', 'wp-carousel-pro' ),
				'options'    => array(
					'rss_feed'     => __( 'RSS Feed', 'wp-carousel-pro' ),
					'youtube_feed' => __( 'Youtube Feed', 'wp-carousel-pro' ),
				),
				'default'    => 'rss_feed',
			...
			array(
				...
				'dependency' => array( 'wpcp_carousel_type|wpcp_external_source_type', '==|==', 'external-carousel|rss_feed' ),
			),

			// YouTube API.
			array(
				'id'         => 'wpcp_youtube_api_key',
				'type'       => 'text',
				'title'      => __( 'Youtube API Key', 'wp-carousel-pro' ),
				'desc'       => __( 'Write your API key. <a href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/configurations/how-to-get-your-youtube-api-key/" target="_blank">Get help</a>', 'wp-carousel-pro' ),
				'dependency' => array( 'wpcp_carousel_type|wpcp_external_source_type', '==|==', 'external-carousel|youtube_feed' ),
			),

			// YouTube channel id.
			array(
				'id'         => 'wpcp_youtube_channel_id',
				'type'       => 'text',
				'title'      => __( 'Youtube Channel ID', 'wp-carousel-pro' ),
				'subtitle'   => __( 'Insert your youtube channel id', 'wp-carousel-pro' ),
				'desc'       => '<a href="#" class="wpcp-youtube-channel-id-generator">Generate Channel ID</a>',
				'dependency' => array( 'wpcp_carousel_type|wpcp_external_source_type', '==|==', 'external-carousel|youtube_feed' ),
			),
			...
			array(
				...
				'options'    => array(
					'latest'            => __( 'Latest', 'wp-carousel-pro' ),
					'featured_products' => __( 'Featured', 'wp-carousel-pro' ),
			...
			array(
				...
				'button_title'           => '<i class="fa fa-plus-circle"></i> ' . __( 'Add Video', 'wp-carousel-pro' ),
				...
				'fields'                 => array(
					array(
						...
						'options' => array(
							...
							'sproutvideo' => array(
								'image' => WPCAROUSEL_URL . 'Admin/img/source/sproutvideo.svg',
								'text'  => __( 'SproutVideo', 'wp-carousel-pro' ),
							),
							'self_hosted' => array(
					...
					array(
						...
						'help'       => sprintf(
							/* translators: %1$s: start bold and italic, %2$s: close bold and italic */
							__( 'Video ID: %1$s2256213277%2$s', 'wp-carousel-pro' ),
							'<b><i>',
							'</i></b>'
						),
					...
					array(
						...
						'help'       => sprintf(
							/* translators: %1$s: start bold and italic, %2$s: close bold and italic */
							__( 'Channel ID: %1$sanimals_nature%2$s', 'wp-carousel-pro' ),
							'<b><i>',
							'</i></b>'
						),
					...
					array(
						...
						'title'      => __( 'Video ID', 'wp-carousel-pro' ),
						'help'       => sprintf(
							/* translators: %1$s: start bold and italic, %2$s: close bold and italic, %3$s: break line */
							__( 'The last part of the URL is the ID e.g: Youtube: %1$seKFTSSKCzWA%2$s %3$sVimeo: %1$s95746815%2$s %3$sTikTok: %1$s7290894255462108434%2$s %3$sDailymotion: %1$sx8qfynk%2$s', 'wp-carousel-pro' ),
							'<b><i>',
							'</i></b>',
							'<br>'
						),
					...
					array(
						'id'         => 'sproutvideo_video_embed_url',
						'class'      => 'wpcp-sproutvideo-video-embed-url',
						'type'       => 'text',
						'title'      => __( 'Video Embed Source', 'wp-carousel-pro' ),
						'help'       => 'https://videos.sproutvideo.com/embed/<br>{video_id}/{security_token}',
						'dependency' => array( 'carousel_video_source_type', '==', 'sproutvideo' ),
					),
					array(
						'id'           => 'sproutvideo_video_thumbnail',
						'type'         => 'media',
						'library'      => array( 'image' ),
						'url'          => false,
						'preview'      => true,
			...
			array(
				...
				'fields'                 => array(
					...
					array(
						...
						'dependency' => array( 'carousel_video_source_type|carousel_mix_source_type', 'any|==', 'youtube,vimeo,dailymotion,tiktok,wistia,sproutvideo|video' ),
					),
					array(
						'id'           => 'carousel_video_source_upload',
						'type'         => 'upload',
