					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'default'    => 'default',
								'dependency' => array( 'wpcp_carousel_type|wpcp_external_source_type', 'any|!=', 'image-carousel,post-carousel,product-carousel,external-carousel|youtube_feed', true ),
							),
							array(
								...
								'default'    => 'bottom',
								'dependency' => array( 'wpcp_carousel_type|wpcp_content_style|wpcp_external_source_type', 'any|==|!=', 'image-carousel,post-carousel,product-carousel,external-carousel|default|youtube_feed', true ),
							),
							array(
							...
							array(
								...
								'dependency' => array( 'wpcp_carousel_type', 'any', 'video-carousel,mix-content,external-carousel', true ),
							),
							array(
								'id'         => 'video_play_mode',
							...
							array(
								'id'         => 'video_autoplay_mode',
								'type'       => 'switcher',
								'title'      => __( 'Video Autoplay', 'wp-carousel-pro' ),
								'subtitle'   => __( 'Enable/Disable video autoplay.', 'wp-carousel-pro' ),
								'text_on'    => __( 'Enabled', 'wp-carousel-pro' ),
								'text_off'   => __( 'Disabled', 'wp-carousel-pro' ),
								'text_width' => 100,
								'default'    => false,
								'title_help' => __( 'When enabled,Video sound will be muted by default.', 'wp-carousel-pro' ),
								'dependency' => array( 'wpcp_carousel_type|video_play_mode', 'any|==', 'video-carousel,mix-content,external-carousel|inline', true ),
							),
							array(
								'id'         => 'video_loop',
								'type'       => 'switcher',
								'title'      => __( 'Video Loop', 'wp-carousel-pro' ),
								'subtitle'   => __( 'Enable/Disable video loop.', 'wp-carousel-pro' ),
								'text_on'    => __( 'Enabled', 'wp-carousel-pro' ),
								'text_off'   => __( 'Disabled', 'wp-carousel-pro' ),
								'text_width' => 100,
								'default'    => false,
					...
					array(
						...
						'fields' => array(
							...
							array(
								...
								'title_help'         => '<div class="sp_wpcp-info-label">' . __( 'Height', 'wp-carousel-pro' ) . '</div><div class="sp_wpcp-short-content">' . __( 'Set image height on various devices for ideal responsiveness. Ensure your content looks great on every screen size with customized image heights.', 'wp-carousel-pro' ) . '</div><a class="sp_wpcp-open-docs" href="https://docs.shapedplugin.com/docs/wordpress-carousel-pro/configurations/how-to-configure-the-image-height-css/" target="_blank">' . __( 'Open Docs', 'wp-carousel-pro' ) . '</a><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/carousel-orientations/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
							...
							array(
								...
								'title_help' => '<div class="sp_wpcp-info-label">Zoom</div><div class="sp_wpcp-short-content">' . __( 'This feature lets you choose a specific zoom effect when hovering over an image for an engaging experience.', 'wp-carousel-pro' ) . '</div><a class="sp_wpcp-open-live-demo" href="https://wpcarousel.io/post-carousel-zoom-image-modes/" target="_blank">' . __( 'Live Demo', 'wp-carousel-pro' ) . '</a>',
								'options'    => array(
							...
							array(
								...
								'desc'       => '<a href="' . esc_url( $single_page_link ) . '" target="_blank">' . __( 'Set watermark image', 'wp-carousel-pro' ) . '→</a>',
								'default'    => false,
