	...
	public function print_media_templates() {
		...
		<script type="text/html" id="tmpl-wpcp_image-meta-editor">
			<div class="edit-media-header">
				<button class="left dashicons"><span class="screen-reader-text"><?php esc_html_e( 'Edit previous media item', 'wp-carousel-pro' ); ?></span></button>
				<button class="right dashicons"><span class="screen-reader-text"><?php esc_html_e( 'Edit next media item', 'wp-carousel-pro' ); ?></span></button>
			</div>
