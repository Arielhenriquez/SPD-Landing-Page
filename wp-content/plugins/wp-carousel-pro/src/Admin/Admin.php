...
class Admin {
	...
	public function sp_wpcp_review_text( $text ) {
		...
		if ( 'sp_wp_carousel' === get_post_type() || 'sp_wp_carousel_page_wpcp_settings' === $screen->id || 'sp_wp_carousel_page_wpcp_help' === $screen->id ) {
			...
			$text = sprintf(
			/* translators: %s: URL for leaving a review */
				__( 'If you like %1$sWP Carousel Pro%2$s, please leave us a %3$s rating. Your review is very important to us as it helps us to grow more.', 'wp-carousel-pro' ),
				'<strong>',
				'</strong>',
	...
	public function declare_compatibility_with_woo_hpos_feature() {
		if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
			...
			if ( ( is_plugin_active( 'wp-carousel-free/wp-carousel-free.php' ) || is_plugin_active_for_network( 'wp-carousel-free/wp-carousel-free.php' ) ) ) {
