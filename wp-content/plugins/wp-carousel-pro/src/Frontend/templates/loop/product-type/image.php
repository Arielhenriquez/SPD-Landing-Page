...
if ( $show_product_image ) {
	if ( has_post_thumbnail() && $show_product_image ) {
		...
		$show_product_badge     = apply_filters( 'sp_wpcp_show_product_badge', true );
		...
		<div class="<?php echo esc_attr( $grid_column ); ?>">
			<div class="wpcp-slide-image">
				<?php
				require self::wpcp_locate_template( 'loop/product-type/product-badge.php' );
				echo $wpcp_product_thumb;
				?>
			</div>
		</div>
				<?php
				...
				?>
		<div class="wpcp-slide-image">
				<?php require self::wpcp_locate_template( 'loop/product-type/product-badge.php' ); ?>
	...
	} elseif ( $thumbnail_slider || 'thumbnails-slider' === $wpcp_layout ) {
		?>
			<div class="<?php echo esc_attr( $grid_column ); ?>">
				<div class="wpcp-slide-image">
