		...
		if ( 'lightbox' === $video_play_mode ) {
			...
			<div class="wcp-video-iframe-wrapper">
				<div class="wcp-video-section wcp-video-inline-mode">
					...
					<img loading="lazy" class="wcp-lazy" data-src="<?php echo esc_url( $sp_url['video_thumb_url'] ); ?>" src="<?php echo esc_url( $sp_url['video_thumb_url'] ); ?>" alt="<?php echo esc_html( $sp_url['video_alt_text'] ); ?>"><i class="fa fa-play-circle-o" aria-hidden="true"></i>

					<!-- Play Button Icon -->
					<button><i class="fa fa-play-circle-o" aria-hidden="true"></i></button>
					<?php if ( 'youtube' === $sp_url['video_type'] ) : ?>
						<!-- YouTube Video Embed -->
						<div class="wcp-video-iframe-wrapper wcp-inline-video-youtube" data-embed="<?php echo esc_attr( $sp_url['video_id'] ); ?>" data-fancybox data-src="<?php echo esc_url( $sp_url['video_url'] ); ?>" data-type="<?php echo esc_attr( $sp_url['video_type'] ); ?>" data-width="600" data-height="400" data-autoplay="<?php echo esc_attr( $video_autoplay ); ?>" data-loop="<?php echo esc_attr( $video_loop ); ?>">
						</div>
					...
					elseif ( isset( $sp_url['video_url'] ) && ! empty( $sp_url['video_url'] ) ) :
						...
						?>
						<!-- Custom Video Embed -->
						<div class="skip-lazy wcp-iframe wcp-lazy-load-video" data-embed="<?php echo esc_url( $sp_url['video_url'] ); ?>" data-autoplay="<?php echo esc_attr( $video_autoplay ); ?>" data-loop="<?php echo esc_attr( $video_loop ); ?>">
						</div>
					<?php endif; ?>
				</div>
			</div>
