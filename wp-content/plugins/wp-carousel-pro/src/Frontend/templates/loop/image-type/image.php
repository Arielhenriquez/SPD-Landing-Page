...
?>
	...
	if ( 'l_box' === $image_link_show && ! $thumbnail_slider ) {
		...
		$desc_limit     = apply_filters(
			'wpcp_limit_l_box_desc',
			array(
				'expand_collapse' => false,
				'character_limit' => '200',
			),
