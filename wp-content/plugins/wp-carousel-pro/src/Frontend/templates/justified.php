...
<div id="wpcpro-wrapper-<?php echo esc_attr( $post_id ); ?>" class="wpcp-carousel-wrapper wpcpro-wrapper wpcp-justified  wpcp-gallery wpcp-wrapper-<?php echo esc_attr( $post_id ); ?> <?php echo $img_protection ? ' wpcp_img_protection' : ''; ?>">
	...
	?>
	<div id="sp-wp-carousel-pro-id-<?php echo esc_attr( $post_id ); ?>" class="<?php echo esc_attr( $carousel_classes ); ?>" <?php echo $lightbox_setting; // phpcs:ignore ?> data-rowheight="<?php echo esc_attr( $justified_row_height ); ?>" data-horizontalgap="<?php echo esc_attr( $slide_margin ); ?>" data-verticalgap="<?php echo esc_attr( $slide_margin_horizontal ); ?>">
