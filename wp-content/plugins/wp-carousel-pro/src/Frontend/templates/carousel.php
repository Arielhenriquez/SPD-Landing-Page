...
?>
	<div id="sp-wp-carousel-pro-id-<?php echo esc_attr( $post_id ); ?>" dir="<?php echo esc_attr( $dir_type ); ?>" class="<?php echo esc_attr( $carousel_classes . $wpcp_vertical ); ?> swiper" <?php echo $carousel_attr; ?> <?php echo $carousel_types; ?> <?php echo $lightbox_setting; // phpcs:ignore ?> data-variableWidth="<?php echo esc_attr( $variable_width ); ?>"> 	
