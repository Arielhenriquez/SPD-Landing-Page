...
/**
 * Fix last image loading issue for the "Center Mode".
 */
if ( 'carousel' === $layout && 'center' === $carousel_mode ) {
	$dynamic_css .= '#wpcpro-wrapper-' . $carousel_id . ' .wpcp-center {
 ...
 * Video Carousel CSS
 */
if ( 'video-carousel' === $carousel_type || 'external-carousel' === $carousel_type ) {
	...
	$dynamic_css     .= '
		#wpcpro-wrapper-' . $carousel_id . ' #sp-wp-carousel-pro-id-' . $carousel_id . '.sp-wpcp-' . $carousel_id . ' .wpcp-single-item.wcp-video-item i{
